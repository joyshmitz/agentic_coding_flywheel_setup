...
- **Магія одного рядка:** Одна команда `curl | bash` встановлює 30+ інструментів, налаштовує все і запускає три ШІ-агенти для кодування
...
- Три ШІ-агенти для кодування (Claude Code, Codex CLI, Gemini CLI)
...
│                          ЦІЛЬОВИЙ VPS                                      │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐   │
│  │ 30+ інстру-  │  │ zsh + p10k   │  │ ШІ-агенти    │  │ ~/.acfs/     │   │
