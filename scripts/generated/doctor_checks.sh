...
declare -a MANIFEST_CHECKS=(
    ...
    "stack.frankenterm	FrankenTerm (ft) - terminal hypervisor and orchestration plane for AI agent swarms	ft --version	optional	target_user"
    ...
    "utils.toon_rust	toon_rust (toon) - Token-optimized object notation for LLM context efficiency	toon --version	optional	target_user"
