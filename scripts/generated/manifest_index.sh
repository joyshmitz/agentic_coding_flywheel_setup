...
ACFS_MANIFEST_SHA256="7d3ca6593e4737ae48dc791e1920f93465e8f6ffbdcb3b5c7fa6c2fafb4ebcd3"
...
declare -gA ACFS_MODULE_FUNC=(
  ...
  ['stack.frankenterm']="install_stack_frankenterm"
...
declare -gA ACFS_MODULE_TAGS=(
  ...
  ['stack.frankenterm']="recommended,automation"
...
declare -gA ACFS_MODULE_DESC=(
  ...
  ['stack.frankenterm']="FrankenTerm (ft) - terminal hypervisor and orchestration plane for AI agent swarms"
  ...
  ['utils.toon_rust']="toon_rust (toon) - Token-optimized object notation for LLM context efficiency"
...
declare -gA ACFS_MODULE_INSTALLED_CHECK=(
  ...
  ['stack.frankenterm']="command -v ft"
