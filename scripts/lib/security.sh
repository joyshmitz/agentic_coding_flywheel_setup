...
declare -gA KNOWN_INSTALLERS=(
    ...
    [frankenterm]="https://raw.githubusercontent.com/Dicklesworthstone/frankenterm/main/install.sh"
    [toon]="https://raw.githubusercontent.com/Dicklesworthstone/toon_rust/main/install.sh"
