...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Twenty interconnected tools that enable multiple AI agents to work in parallel, coordinate automatically, and make autonomous progress. Using three tools is 10x better than one.",
    type: "website",
  ...
  twitter: {
    ...
    title: "The Flywheel - 20 Tools for 10x Velocity",
    description:
      "Twenty interconnected tools that enable multiple AI agents to work in parallel and make autonomous progress.",
