...
export const manifestTldrTools: ManifestTldrTool[] = [
  ...
  },
  {
    ...
    tldrSnippet: "FrankenTerm (ft) - terminal hypervisor and orchestration plane for AI agent swarms",
    icon: "monitor",
    color: "#06B6D4",
  ...
  },
  {
    ...
    tldrSnippet: "toon_rust (toon) - Token-optimized object notation for LLM context efficiency",
    icon: "minimize-2",
    color: "#06B6D4",
