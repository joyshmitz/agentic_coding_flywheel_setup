...
export const manifestTools: ManifestWebTool[] = [
  ...
  },
  {
    ...
    displayName: "FrankenTerm",
    shortName: "FT",
    tagline: "Terminal hypervisor for multi-agent automation",
    shortDesc: "FrankenTerm (ft) - terminal hypervisor and orchestration plane for AI agent swarms",
    icon: "monitor",
    color: "#06B6D4",
  ...
  },
  {
    ...
    shortName: "TOON",
    tagline: "Encode JSON as token-efficient object notation",
    shortDesc: "toon_rust (toon) - Token-optimized object notation for LLM context efficiency",
    icon: "minimize-2",
    color: "#06B6D4",
    href: "https://github.com/Dicklesworthstone/toon_rust",
    features: [
      "40-70% token count reduction",
      "Strict JSON to TOON encoding",
    ...
    useCases: [
      "Fitting more structured data into LLM requests",
      "Reducing token costs for JSON payloads",
      "Round-tripping TOON and JSON",
    ],
    language: "Rust",
    stars: 156,
    cliName: "toon",
    cliAliases: [],
    commandExample: "toon --encode < data.json",
  },
  {
    id: "utils-xf",
    moduleId: "utils.xf",
